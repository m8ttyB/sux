...
class TestSmokeTests:
    ...
    def test_this_should_work(self, base_url, selenium):
        selenium.get(base_url)
        selenium.execute_script(open("./src/aria-highlighter.js").read())
        assert screenshot_matches(selenium, "/home/mbrandt/workspace/sux/highlighter/screenshots/test_this_should_work")
